...
********************************************************
    ...
    https://github.com/damienvingrief/linechart_2

  private static final int SIGNAL_MAIN_START  = 1;
  private static final int SIGNAL_SPY_START   = 2;
  private static final int SIGNAL_MOTION      = 5;
  private static final int SIGNAL_LIGHT       = 6;
  private static final int SIGNAL_SCREEN      = 8;
  private static final int SIGNAL_VOLUME      = 10;
  private static final int SIGNAL_CHARGING    = 12;
  private static final int SIGNAL_BATTERY     = 13;
  private static final int SIGNAL_REBOOT      = 16;
  private static final int SIGNAL_SPY_STOP    = 19;
  private static final int SIGNAL_MAIN_STOP   = 20;
  private static final int SIGNAL_OTHER       = 25;


*******************************************************/
function getSignal_new(t){
    if(t==1)    return "Main";
    if(t==2)    return "Spy";
    if(t==5)    return "Move";
    if(t==6)    return "Ligh";
...
function getSignal(t){
    ...
    if(t==8)    return "SPY";
    if(t==10)   return "LowB";
    if(t==15)   return "Alert";
    return "";
}

(function ($){ $.linechart_2 = function (o){
    ...
    // Container init
    var wrap = $('#'+o.id).addClass('linechart_2');
    ...
    for (i=0;i<maxY;i+= 1)
        c.fillText(getSignal(i), o.gridPaddingX - 2, getPixelY(i));
